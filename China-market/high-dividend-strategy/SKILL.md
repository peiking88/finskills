---
name: cn-high-dividend-strategy
description: 分析A股高股息策略，评估红利股的收益可持续性与长期回报。当用户询问高股息股票、红利策略、A股分红分析、现金分红覆盖率、中证红利指数成分股、股息率排名或长期收入型投资时使用此技能。 也适用于用户问"哪些股票分红多"、"有没有稳定吃股息的股票"、"帮我找分红好的公司"、"靠分红能赚多少"时。
license: Apache-2.0
---
