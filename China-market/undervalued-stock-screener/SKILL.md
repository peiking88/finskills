---
name: cn-undervalued-stock-screener
description: 扫描A股市场，筛选基本面强劲但市值被低估的上市公司。当用户询问低估值股票、价值投资筛选、A股便宜股票、低PE或低PB公司、基本面强但被低估的公司、或要求运行估值筛选器时使用此技能。 也适用于用户问"有什么便宜的好股票"、"帮我找找被低估的"、"哪些股票在打折"、"A股现在捡漏机会"时。
license: Apache-2.0
---
