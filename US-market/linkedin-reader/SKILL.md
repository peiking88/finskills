---
name: us-linkedin-reader
description: Read LinkedIn for financial research using opencli (read-only). Use when the user wants to read their LinkedIn feed, search for finance/trading jobs, view professional posts about markets or earnings, or gather professional sentiment. Also trigger when someone says "check my LinkedIn feed", "search LinkedIn for", "LinkedIn posts about", "what's on LinkedIn about AAPL", "finance jobs on LinkedIn", "LinkedIn market sentiment", "who's posting about earnings on LinkedIn", "professional network buzz", or mentions LinkedIn in context of financial research. READ-ONLY. Requires opencli + Chrome browser.
license: Apache-2.0
---
