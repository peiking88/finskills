---
name: us-telegram-reader
description: Read Telegram channels and groups for financial news and market research using tdl (read-only). Use when the user wants to read Telegram channels, export messages from financial groups, list chats, search for news, or gather market intelligence from Telegram. Also trigger when someone says "check my Telegram", "read Telegram channel", "Telegram news", "what's new in my Telegram channels", "export messages from", "financial news on Telegram", "crypto Telegram", "market news Telegram", or mentions Telegram in context of financial research. READ-ONLY. Requires tdl CLI + Telegram account.
license: Apache-2.0
---
