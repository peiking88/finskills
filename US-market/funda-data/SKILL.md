---
name: us-funda-data
description: Fetch financial data from the Funda AI API (https://api.funda.ai). Covers quotes, historical prices, financials, SEC filings, transcripts, analyst estimates, options flow/greeks/GEX, supply chain graph, social sentiment, Polymarket, congressional trades, economics, ESG, news, AI-enriched news, AI-company recruit signals, and a Claude API proxy. Use when the user needs comprehensive financial data beyond what yfinance provides. Also trigger when someone says "funda", "funda.ai", "get me options flow", "supply chain for NVDA", "AI company hiring signals", "congressional trades", "Polymarket odds", "SEC filings search", "earnings call transcript", or asks for data the free findata-toolkit cannot provide. Requires paid Funda AI subscription (FUNDA_API_KEY).
license: Apache-2.0
---
